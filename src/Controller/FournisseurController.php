...
class FournisseurController extends AbstractController
{
    ...
    {
        return $this->render('fournisseur/index.html.twig', ['fournisseurs' => $fournisseurRepository->findAll()]);
    }
    ...
    public function edit(Request $request, Fournisseur $fournisseur): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('fournisseur_index', ['id' => $fournisseur->getId()]);
        }
