...
class VenteController extends AbstractController
{
    ...
    {
        return $this->render('vente/index.html.twig', ['ventes' => $venteRepository->findAll()]);
    }
    ...
    {
        return $this->render('vente/show.html.twig', ['vente' => $vente]);
    }
    ...
    public function edit(Request $request, Vente $vente): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('vente_index', ['id' => $vente->getId()]);
        }
